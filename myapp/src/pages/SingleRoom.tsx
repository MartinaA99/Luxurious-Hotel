...
export default class SingleRoom extends Component<IPropsSingleRoom, IStateSingleRoom> {
        ...
        public render() {
            ...
            let pathIndex = pathParams.lastIndexOf("/")
            let urlSlug = pathParams.substring(pathIndex+1)
 
            const unknownVariable: unknown = this.context;
            const room = (unknownVariable as any).getRoom(urlSlug);
