...
class RoomProvider extends Component<PropsWithChildren<any>, IStateContext> {
...
export const withRoomConsumer = <P extends {}>(Component: React.ComponentClass<P> | React.FunctionComponent<P>): React.FC<any> => props => {
    return <RoomConsumer>
